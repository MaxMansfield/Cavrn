...
/*
  SPI_MODEn is the bit mask of the CPOL and CPHA bits which can be directly used
  to set SPCR
 */
 ...
 */
void spi_multiTransfer(const byte* const dataout,byte* const  datain,const uint8_t len);
